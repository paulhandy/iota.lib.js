...
*
**/
var genSubseed = function(seed, index) {
...
var genKey = function(seed, index, length) {
    return genSubkey(genSubseed(seed, index), length);
}

var genSubkey = function(subseed, length) {
    var kerl = new Kerl( );
